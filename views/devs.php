        ...
        >
          ...
          >
            ...
            >
              ...
              <!-- textos -->
              <h1 class="mt-3">Weverton Ryan</h1>
              <p class="mt-3">Descrição</p>

              <!-- redes -->
              <div class="flex flex-row justify-center items-center gap-4 mt-4">
                <!-- github -->
                <a name="github" href="https://github.com/wevertonryan/"
                  ><svg
                    width="30px"
                    height="30px"
                    viewBox="0 0 21 20"
          ...
          >
            ...
            >
              ...
              <!-- textos -->
              <h1 class="mt-3">Bruno Righi</h1>
              <p class="mt-3">Descrição</p>

              <!-- redes -->
              <div class="flex flex-row justify-center items-center gap-4 mt-4">
                <!-- github -->
                <a name="github" href="https://github.com/BrunoozL/"
                  ><svg
                    width="30px"
                    height="30px"
                    viewBox="0 0 21 20"
