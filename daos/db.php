    ...
    private function createTables()
    {
        $sql = "
            ...
            CREATE TABLE IF NOT EXISTS users_common (
                id_users_common BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                user_id BIGINT,
            ...
            CREATE TABLE IF NOT EXISTS users_company (
                id_users_company BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
                user_id BIGINT,
            ...
            CREATE TABLE IF NOT EXISTS UNSIGNED orders (
